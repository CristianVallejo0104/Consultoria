---
name: evaluador-retencion
description: Opera el evaluador de retención de LLMs en conversaciones largas. Úsalo para revisar el estado de Ollama, correr evaluaciones con ejecutar_evaluacion() y resumir los JSON de resultados. No edita código.
